...
mainMenu.Items:Boolean("useCut", "Use Cutless", true)
mainMenu.Items:Boolean("useBork", "Use Bork", true)
mainMenu.Items:Boolean("useGhost", "Use Youmuu's", true)
mainMenu.Items:Boolean("useHydra", "Use Hydra  - Timat", true)
mainMenu.Items:Slider("extraDelay","Auto Attack Delay Reset", 10 , 0, 50, 1)
mainMenu.Items:Boolean("useRedPot", "Red Pot Use", true)
-----------------------------------------------------------------
...
mainMenu.Drawings:Boolean("DrawWShadow", "W - Shadow Drawing", false)
mainMenu.Drawings:Boolean("DrawRShadow", "R - Shadow Drawing", false)
